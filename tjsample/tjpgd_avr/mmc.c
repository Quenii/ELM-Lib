...
#define	FORWARD(d)						/* Data forwarding function */

#define	_USE_WRITE	0	/* Read-only configuration */
...
static
void dly_100us (void)		/* Delay 100 microseconds (9MHz) */
{
	int n = 100;
...
void init_spi (void)		/* Initialize SPI port */
{
	...
	for (n = 200; n; n--)	/* Wait for 20ms */
		dly_100us();

	PORTB = 0b10110101;		/* Enable drivers */
	DDRB  = 0b11000111;

	SPCR = 0x50;			/* Enable SPI function in mode 0 */
